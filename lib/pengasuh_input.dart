...
class PengasuhInputDataPage extends StatelessWidget {
  ...
  final TextEditingController toiletActivityController =
  ...
  final TextEditingController afternoonShowerController =
      TextEditingController();
